 ...
 * This file test the solver method
 */
...
public class TestSolvers {
	...
	public void checkMaze(PriorityQueue<Integer,Square> pq, 
			Maze startMaze, String[] expected) {
	...
	public void testMazeSolver_noSolution() {
		...
		int[][] costs = new int[][]
			...
			{2,0,0,0},
			{1,5,3,10}};
		Maze m = new Maze(stringArray, costs);
		PriorityQueue<Integer,Square> pq = new Heap<Integer, Square>(new minComparetor());
	...
	public void testMazeSolver_solutionLong() {
		...
		String output[] = new String[]
				  {"***S",
				   ...
				   "*##_",
				   "***F"};
		Maze m = new Maze(inputString, costs);
	...
	public void testMazeSolver_solution_1x8() {
		...
		String inputString [] = new String[] {"F______S"};
		int[][] costs = new int[][] {{1,1,1,1,1,1,1,0}};


		String output[] = new String[] {"F******S"};
		Maze m = new Maze(inputString, costs);
		checkMaze(new Heap<Integer, Square>(new IntComparator()), m, output);		
	}
	@Test
	public void testMazeSolver_noSolution_1x8() {
		...
		String inputString [] = new String[] {"F__#___S"};
		int[][] costs = new int[][]  {{1,1,1,0,1,1,1,0}};
		Maze m = new Maze(inputString, costs);
